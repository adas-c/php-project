...
const likes = new _modules_Likes__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class Like {
  ...
  async createLike(currentLikeBox) {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(uniData.root_url + "/wp-json/uni/v1/manageLike", {
...
class MyNotes {
  ...
  async deleteNote(e) {
    const thisNote = this.findNearestParentLi(e.target);
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(uniData.root_url + "/wp-json/wp/v2/notes/" + thisNote.getAttribute("data-id"));
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(uniData.root_url + "/wp-json/wp/v2/notes/" + thisNote.getAttribute("data-id"), ourUpdatedPost);
      this.makeNoteReadOnly(thisNote);
    } catch (e) {
      console.log("Sorry");
    }
  ...
  async createNote() {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(uniData.root_url + "/wp-json/wp/v2/notes/", ourNewPost);
...
class Search {
  ...
  async getResults() {
    try {
      const respons = await (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])(uniData.root_url + "/wp-json/uni/v1/search?term=" + this.searchField.value);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknewtheme"] = self["webpackChunknewtheme"] || [];
